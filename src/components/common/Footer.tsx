const Footer: React.FC = () => {
  return (
    <footer className="flex justify-center items-center gap-x-4 py-3 shadow-lg border-t border-white dark:border-gray-700 bg-background-dark">
      ...
      <div className="flex text-white space-x-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-link-light dark:hover:text-link-dark"
          aria-label="LinkedIn"
        >
          <LinkedInIcon />
        </a>
